...
const keyboardFristRow = document.querySelector("#keyboardFristRow");
...
const createKeyboardRow = (keys, keyboardRow) => {
  keys.forEach((key) => {
    var buuttonElement = document.createElement("button");
    buuttonElement.textContent = key;
    buuttonElement.setAttribute("id", key);
    buuttonElement.addEventListener("click", () => handleKeyboardOnClick(key));
    keyboardRow.append(buuttonElement);
  });
};

createKeyboardRow(keysFirstRow, keyboardFristRow);
